...
export default function Skeleton() {
  ...
  const divCount = Math.floor(Math.random() * 6) + 1;

  // Generate an array of random widths using Tailwind classes
  ...
  return (
    <div className="overflow-hidden relative border-[#F2F0E4]/30 z-10 w-full backdrop-blur-[2px] p-3 light-text border rounded-3xl">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex animate-pulse opacity-25 bg-black rounded-3xl px-4 py-2 items-center">
          <svg

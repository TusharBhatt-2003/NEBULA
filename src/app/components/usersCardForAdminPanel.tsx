  ...
  return (
    <>
      {user ? (
        ...
        >
          ...
          <div className="border-l pl-2">
            ...
            <p className="text-sm text-base-content/50">
              Tags Followed:{" "}
              {user.followingTags ? user.followingTags.length : 0}
            </p>
          </div>
        ...
        <div
          className="border w-full p-7 z-20 light-text flex justify-between items-center overflow-hidden rounded-xl"
          style={{ backgroundColor, color: textColor, borderColor }}
        ></div>
      )}
    </>
